...
public class ToyStringExampleDict {
	...
	public static void main(String[] args) throws Exception {
        ...
        ////S2W-TIK "DICTIONARY" ESKURATU ETA FDS2W FILTROA OSATU --> TEST SORTA LORTU (BOW [SPARSE])
        ...
        fds2w.setInputFormat(testRaw);
        Instances testBoW_sparse = Filter.useFilter(testRaw, fds2w); 
